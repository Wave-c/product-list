...
public final class StreamObserverUtility 
{
    private StreamObserverUtility(){}

    public static <Target, Source> StreamObserver<Source> proxyStream(StreamObserver<Target> target, Function<Source, Target> handler)
    {
